...
class Cart(object):
    ...
    def add(self, product, quantity=1, update_quantity=False):
        ...
        update_quantity – булево значение, которое говорит о том, нужно ли заменить
        значение количества товаров на новое (True) или следует добавить
        его к существующему (False)
        """
